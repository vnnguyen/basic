<?
Yii::$app->params['page_title'] = Yii::t('m', 'PHP information');
Yii::$app->params['page_breadcrumbs'] = [
	[Yii::t('m', 'Master CP'), 'mcp'],
	[Yii::t('m', 'PHP information')],
];
?>
<div class="col-md-12">
    <div class="xpanel xpanel-default" style="border:0;">
<?
ob_start();
phpinfo();
...
$output = preg_replace("/<table(.*?)>/", "\n\n<table\\1 class=\"mb-20 table table-condensed table-striped table-bordered\" style=\"border-top-width:2px\" cellspacing=\"0\">", $output);
