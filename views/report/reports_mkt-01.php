...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h6 class="panel-title">Thống kê năm <?= $y ?> | Chọn <?= Html::a('2015', '?y=2015&s='.$s, ['class'=>'text-danger']) ?> hoặc <?= Html::a('2014', '?y=2014&s='.$s, ['class'=>'text-danger']) ?>. Click cột 1 để lọc theo site. <?= Html::a('Đặt lại', '?y='.$y, ['class'=>'text-danger']) ?></h6>
		</div>
		<table class="table table-condensed table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><?= Html::a($tour['name'], 'https://'.$url, ['target'=>'_blank']) ?></td>
					<td><?= $url ?></td>
