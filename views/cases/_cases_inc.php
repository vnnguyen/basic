...
Yii::$app->params['page_breadcrumbs'] = [
    [Yii::t('x', 'Cases'), 'cases'],
    isset($theCase['id']) ? [Yii::t('x', 'View'), SEG3 != '' ? 'cases/'.$theCase['id'] : null] : null,
    SEG3 == 'upa' ? [Yii::t('x', 'Edit source')] : null,
];
...
if (isset($theCase['id'])) {
    Yii::$app->params['page_actions'][] = [
        ...
        ['submenu'=>[
            ...
            ['-'],
            ['icon'=>'lock', 'label'=>'Close', 'link'=>'cases/'.$theCase['id'].'/close', 'active'=>SEG3 == 'close', 'hidden'=>$theCase['status'] == 'closed'],
            ['icon'=>'unlock', 'label'=>'Re-open', 'link'=>'cases/'.$theCase['id'].'/reopen', 'active'=>SEG3 == 'reopen', 'hidden'=>$theCase['status'] != 'closed'],
            ['icon'=>'clock-o', 'label'=>'Put on hold', 'link'=>'cases/'.$theCase['id'].'/hold', 'active'=>SEG3 == 'hold', 'hidden'=>$theCase['status'] == 'onhold'],
            ['icon'=>'clock-o', 'label'=>'Re-activate', 'link'=>'cases/'.$theCase['id'].'/unhold', 'active'=>SEG3 == 'unhold', 'hidden'=>$theCase['status'] != 'onhold'],
            ['-'],
