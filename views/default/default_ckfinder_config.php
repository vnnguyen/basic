...
//     'name'              => 'attachments', // Single quotes not allowed.
//     'directory'         => 'attachments',
//     'maxSize'           => 0,
//     'allowedExtensions' => 'tiff,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
//     'deniedExtensions'  => '',
//     'backend'           => 'default'
// ];
