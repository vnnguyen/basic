...
{
	return isset($_SESSION['ckfinder_authorized']) && $_SESSION['ckfinder_authorized'];
	return false;
}

if (isset(
	$_SESSION['ckfinder_base_url'],
	$_SESSION['ckfinder_base_dir'],
	$_SESSION['ckfinder_role'],
	$_SESSION['ckfinder_thumbs_dir'],
	$_SESSION['ckfinder_resource_name']
	)):

$config['LicenseName'] = 'Fork CMS';
$config['LicenseKey'] = 'VNA6-BP17-T7D3-CP1B-EMJF-X7Q3-5THF';

$baseUrl = $_SESSION['ckfinder_base_url'];
$baseDir = $_SESSION['ckfinder_base_dir'];

$config['Thumbnails'] = Array(
		'url' => 'https://my.amicatravel.com/storage/ckfinder/'.$_SESSION['ckfinder_thumbs_dir'],
		'directory' => '/var/www/my.amicatravel.com/www/storage/ckfinder/'.$_SESSION['ckfinder_thumbs_dir'],
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
*/
$config['RoleSessionVar'] = 'ckfinder_role';
//session_start();
...
$config['ResourceType'][] = [
	'name' => $_SESSION['ckfinder_resource_name'],
	'url' => $baseUrl,
	'directory' => $baseDir,
	'maxSize' => 0,
	'allowedExtensions' => 'swf,flv,bmp,gif,jpeg,jpg,png,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
	'deniedExtensions' => ''
];
