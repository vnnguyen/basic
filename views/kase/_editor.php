...
?>
				<div style="height:44px;" class="write-toggle" onclick="$('.write-toggle').toggle();">Click here or press <kbd>p</kbd> to post</div>
				<div style="display:none;" class="write-toggle">
					<form method="post" action="">
						...
						<p><textarea id="editor" class="form-control" name="body" rows="8" style="min-height:200px;"></textarea></p>
