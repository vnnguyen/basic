...
<div class="col-md-8">
	<div class="alert alert-info">
		...
		<strong>NOTE</strong>
		Một người mới sẽ được thêm, sau đó bạn sẽ chuyển đến trang nhập thông tin chi tiết cho người đó. Nếu bạn muốn thêm profile lái xe cho một người đã có, hãy chọn từ <a class="alert-link" href="<?= DIR ?>users">Danh sách mọi người</a>.
	</div>
	<div class="row">
