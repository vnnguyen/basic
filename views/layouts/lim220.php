            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                    <div class="card-body">
                        <div class="media">
                            <div class="mr-3">
                                <a href="#"><img src="/timthumb.php?w=100&h=100&src=<?= USER_ID == 1 ? '/assets/img/placeholder.jpg' : Yii::$app->user->identity->image ?>" width="38" height="38" class="rounded-circle" alt=""></a>
                            </div>
