...
use app\assets\Limitless220Asset as MainAsset;
...
@media (min-width:1400px) {
    #lisearch {width:600px!important;}
}
@media (min-width:1600px) {
    #lisearch {width:850px!important;}
}
@media (min-width:1800px) {
    #lisearch {width:1100px!important;}
}
...
<body class="<?= Yii::$app->params['body_class'] ?? '' ?>">
    <?php $this->beginBody(); ?>
    <!-- Main navbar -->
    <div class="navbar navbar-expand-md navbar-dark bg-indigo d-print-none fixed-top">
        <div class="navbar-brand d-flex justify-content-start">
            <a href="/" class="-d-inline-block text-nowrap">
                <?php if (ORG_ID == 1) { ?>
                <img src="/assets/img/logo_165x128_c.png" alt="Logo">
                <?php  } else { ?>
                <img src="/assets/img/logo_si_160922_632x440_notext.png" alt="Logo">
                <?php } ?>
            </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="/hotels"><i class="slicon-home"></i> <?= Yii::t('x', 'Hotels') ?></a>
                        <a class="dropdown-item" href="/homestays"><i class="slicon-home"></i> <?= Yii::t('x', 'Homestays') ?></a>
    ...
    <div class="page-content">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="font-size-xs opacity-50">
                                    <i class="icon-pin font-size-sm"></i> &nbsp;<?= ORG_ID == 1 ? 'Amica Travel' : 'Secret Indochina' ?>
                                </div>
                            </div>
        ...
        <div class="sidebar sidebar-light sidebar-secondary sidebar-expand-md sidebar-fixed">
        ...
        <div class="content-wrapper">
            ...
            <?php if (strpos(Yii::$app->params['page_layout'], '-f') === false) { ?>
            <!-- Footer -->
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/5c529a9bab5284048d0fb03b/default';
    s1.charset='UTF-8';
