...
use app\assets\SmartAdmin402Asset as MainAsset;
...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <?= $this->head(); ?>
        <link id="mytheme" rel="stylesheet" type="text/css" href="/themes/smartadmin_4.0.2/css/themes/cust-theme-4.css">
        <style>
        body {font-size:1rem;}
        </style>
    </head>
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="/themes/smartadmin_4.0.2/img/logo.png" alt="Amica Travel IMS" aria-roledescription="logo">
                            <span class="page-logo-text mr-1">Amica Travel IMS</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="/timthumb.php?w=100&h=100&src=<?= Yii::$app->user->identity->image ?>" class="profile-image rounded-circle" alt="<?= Yii::$app->user->identity->name ?>">
                            <div class="info-card-text">
                                <a href="#" class="d-flex align-items-center text-white">
                                    <span class="text-truncate text-truncate-sm d-inline-block">
                                        <?= Yii::$app->user->identity->contact->name ?>
                                    </span>
                                </a>
                                <span class="d-inline-block text-truncate text-truncate-sm"><?= Yii::$app->user->identity->contact->memberProfile->location ?></span>
                            </div>
                            <img src="/themes/smartadmin_4.0.2/img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            if (isset(Yii::$app->params['side_nav'][Yii::$app->params['side_nav_name']])) {
                                ...
                                foreach (Yii::$app->params['side_nav']['main'] as $item) {
                                    echo renderSmartAdminMainNavItem($item);
                                }
                            } ?>
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <!-- app user menu -->
                            <div>
                                <a href="#" data-toggle="dropdown" title="<?= Yii::$app->user->identity->name ?>" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="/timthumb.php?w=100&h1=100&src=<?= Yii::$app->user->identity->image ?>" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/timthumb.php?w=100&h=100&src=<?= Yii::$app->user->identity->image ?>" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg"><?= Yii::$app->user->identity->name ?></div>
                                                <span class="text-truncate text-truncate-md opacity-80"><?= Yii::$app->user->identity->email ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <div class="dropdown-menu">
                                            <?php foreach (['en'=>'English', 'fr'=>'Français', 'vi'=>'Tiếng Việt'] as $langCode=>$langName) { ?>
                                            <a href="/select/lang/en" class="dropdown-item<?= Yii::$app->language == $langCode ? ' active' : '' ?>" -data-action="lang" -data-lang="en"><?= $langName ?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
...
#div0 {-height:calc(100vh) - 105px; }
#div1 {background-color:yellow; height:calc(100vh); display:grid; grid-template-rows:1fr; overflow-y:auto;}
#div2x {height:calc(100vh); display:grid; grid-template-rows:1fr; overflow-y:auto;}
.cost-list-header {-width:calc(100% - 300px);}
.day-list-item {font-size:.90rem;}
...
#div0 {display:grid; grid-template-columns:360px 1fr;}
.-cost-list-header {-width:calc(100% - 360px);}
.day-list-item {font-size:.95rem;}
}

@media screen and (min-width:1300px) and (max-width:1599px) {
#div0 {display:grid; grid-template-columns:420px 1fr;}
.-cost-list-header {-width:calc(100% - 420px);}
.day-list-item {font-size:1rem;}
#my-sidebar2 .sidebar-content {left:56px;}
}

@media screen and (min-width:1600px) {
#div0 {display:grid; grid-template-columns:480px 1fr;}
.-cost-list-header {-width:calc(100% - 480px);}
.day-list-item {font-size:1rem;}
}

.day-list-item {display:grid; grid-template-columns:20px 1fr; grid-column-gap:8px; border-bottom:1px solid #ddd; padding:6px 6px;}
    .day-list-item .day-count {color:#444;}
    .day-list-item .day-date {font-size:0.8rem; color:#444; font-weight:bold;}
    .day-name-meals {display:grid; grid-template-columns:auto 32px; justify-content:space-between;}
        .day-list-item .day-name {color:#333; -font-size:.95rem; -font-weight:bold;}
        .day-list-item .day-name:hover {color:#000; text-decoration:underline;}
        .day-list-item .day-meals {font-style:italic; color:#777;}
        .text-tournote {font-size:0.9rem;}
        .text-tournote::before {content:"‣";}

.auto-note::before {content:"‣";}
.text-tournote::before {content:"‣";}
.auto-note {font-size:.9rem;}
#day-list.compact .auto-note, #day-list.compact .text-tournote {display:none;}
#day-list.compact .day-content {display:grid; grid-template-columns: minmax(170px, auto) 1fr; grid-column-gap:8px}
#day-list.compact .day-date {font-size:.95rem; font-weight:normal; color:#999;}
    */
</style>
                    <!-- BEGIN Page Content -->
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <?php if (!empty(Yii::$app->params['page_icon'])) { ?><i class="subheader-icon fal fa-<?= Yii::$app->params['page_icon'] ?>"></i><?php } ?>
                                <?= Yii::$app->params['page_title'] ?>
                                <?php if (!empty(Yii::$app->params['page_small_title'])) { ?><span class='fw-300'> - <?= Yii::$app->params['page_small_title'] ?></span><?php } ?>
                                <?php if (!empty(Yii::$app->params['page_sub_title'])) { ?><small><?= Yii::$app->params['page_sub_title'] ?></small><?php } ?>
                            </h1>
                        ...
                        <?php } // -b ?>
                        <?php if (!empty($this->block['page_sidebar'])) { ?>
                        <div id="div0">
                            <div id="div1">
                                <p>LE LE LE</p>
<?php
for ($i = 1; $i < random_int(50, 80); $i ++) {
    echo ' ', Yii::$app->security->generateRandomString(random_int(3, 14));
}
?>
                            </div>
                            <div id="div2">
                    ...
                    <?php } else { ?>
                        <style>.page-content {padding:20px} </style>
                        <div class="row"><?= $content ?></div>
                    <?php } ?>
                    </main>
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">IMS by Amica Travel - <a href="https://www.amica-travel.com" class='text-primary fw-500' title="amica-travel.com" target="_blank">amica-travel.com</a></span>
                        </div>
                        <div>
                            <ul class="list-table m-0">
                                <li><a href="#" class="text-secondary fw-700"><?= Yii::t('x', 'About') ?></a></li>
                                <li class="pl-3"><a href="#" class="text-secondary fw-700"><?= Yii::t('x', 'Documentation') ?></a></li>
                                <li class="pl-3"><a href="#" class="text-secondary fw-700"><?= Yii::t('x', 'Contact') ?></a></li>
                        ...
                        <div class="settings-panel">
                            ...
                            <div class="expanded theme-colors pl-5 pr-3">
                                <ul class="m-0">
                                    ...
                                    <li>
                                        <a href="#" id="myapp-1" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-1.css" data-toggle="tooltip" data-placement="top" title="Tapestry" data-original-title="Tapestry"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-2" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-2.css" data-toggle="tooltip" data-placement="top" title="Atlantis" data-original-title="Atlantis"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-3" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-3.css" data-toggle="tooltip" data-placement="top" title="Indigo" data-original-title="Indigo"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-4" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-4.css" data-toggle="tooltip" data-placement="top" title="Dodger Blue" data-original-title="Dodger Blue"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-5" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-5.css" data-toggle="tooltip" data-placement="top" title="Tradewind" data-original-title="Tradewind"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-6" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-6.css" data-toggle="tooltip" data-placement="top" title="Cranberry" data-original-title="Cranberry"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-7" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-7.css" data-toggle="tooltip" data-placement="top" title="Oslo Gray" data-original-title="Oslo Gray"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-8" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-8.css" data-toggle="tooltip" data-placement="top" title="Chetwode Blue" data-original-title="Chetwode Blue"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-9" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-9.css" data-toggle="tooltip" data-placement="top" title="Apricot" data-original-title="Apricot"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-10" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-10.css" data-toggle="tooltip" data-placement="top" title="Blue Smoke" data-original-title="Blue Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-11" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-11.css" data-toggle="tooltip" data-placement="top" title="Green Smoke" data-original-title="Green Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-12" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-12.css" data-toggle="tooltip" data-placement="top" title="Wild Blue Yonder" data-original-title="Wild Blue Yonder"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="myapp-13" data-action="theme-update" data-themesave data-theme="/themes/smartadmin_4.0.2/css/themes/cust-theme-13.css" data-toggle="tooltip" data-placement="top" title="Emerald" data-original-title="Emerald"></a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="mb-0 mt-4">
...
$this->registerJs("$('.fa').addClass('fal')");