	...
	<div class="row">
		<div class="col-md-9">
			<div class="widget ">				
				...
				<div class="innerAll half bg-gray border-bottom">
					<a href="#" class="btn btn-xs btn-default pull-right"><i class="fa fa-plus fa-fw"></i> New Topic</a>
					<h4 class=" margin-bottom-none">General Discussion</h4>
			...
			<div class="widget">
				...
				<div class="innerAll half bg-gray border-bottom">
					...
					<h4 class=" margin-bottom-none">Customization</h4>
					<div class="clearfix"></div>
				</div>
				<!-- End Category Heading -->
				<!-- Category Listing -->
		...
		<div class="col-md-3">
			...
			<div class="widget">
				...
				<!-- Heading -->
				<h5 class="innerAll half margin-bottom-none bg-primary"><i class="fa fa-user fa-fw"></i> Recent Members</h5>
			...
			<div class="widget">
				...
				<!-- Heading -->
				<h5 class="innerAll half margin-bottom-none bg-primary"><i class="fa fa-refresh fa-fw"></i> Latest Posts</h5>
