...
<div class="col-md-12">
    <form class="form-inline panel-search" id="formx">
        ...
        <?= Html::dropdownList('vat', $vat, [''=>'Hoá đơn', 'nok'=>'Chưa lấy', 'ok'=>'Đã lấy'], ['class'=>'form-control']) ?>
        <?= Html::dropdownList('orderby', $orderby, [
        'updated_at'=>'Xếp theo ngày sửa',
        'plus'=>'Xếp theo ngày tour',
        'supplier'=>'Xếp theo NCC',
        ], ['class'=>'form-control']) ?>
        ...
        |
        <a href="#" onclick="$('#help').toggle(); return false;">?</a>
    </form>
