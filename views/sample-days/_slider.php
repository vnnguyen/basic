...
<div class="slide-block">
    <div class="ks-header">
        <h4 class="panel-title" id="ks-title">Title</h4>
        <i class="pull-right fa fa-times ks-settings-slide-close-control"></i>
    </div>
    <hr>
    <p><button class="action-copy-text" data-clipboard-target="#ks-body">Copy text</button> or <a id="ks-link" href="#">View day</a></p>
    <div class="ks-body" id="ks-body">
        (Content)
    </div>
</div>