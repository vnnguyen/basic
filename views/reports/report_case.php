...
include(Yii::getAlias('@app').'/views/kase/_kase_inc.php');
...
Yii::$app->params['page_title'] = 'Báo cáo HSBH';

$arr_title = [
    'month_open' => 'Hồ sơ theo tháng mở',
    'month_end' => 'Hồ sơ theo tháng tour kết thúc',
    'month_start' => 'Hồ sơ theo tháng tour khởi hành',
];
Yii::$app->params['page_title'] = $arr_title[$case_type];
Yii::$app->params['page_breadcrumbs'] = [
    ['Reports', 'reports'],
    ['Cases'],
];
Yii::$app->params['page_actions'] = null;
...
<div class="col-md-12">
    <div class ="search">
            ...
            <form method="get" action="" class="form-horizontal panel-search">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <?= Html::dropdownList('prospect', $prospect, [
                                'all'=>'Prospect',
                                '1'=>'1 star',
                                '2'=>'2 stars',
                                '3'=>'3 stars',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <?= Html::dropdownList('device', $device, [
                                'all'=>'Device',
                                'desktop'=>'desktop',
                                'tablet'=>'tablet',
                                'mobile'=>'mobile',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <?= Html::dropdownList('found', $found, $kaseHowFoundListFormatted, ['class'=>'form-control', 'prompt'=>Yii::t('k', 'How customer found us')]) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="language">
                                ...
                                <option value="fr" <?= $language == 'fr' ? 'selected="selected"' : ''?>>Francais</option>
        ...
        <p class="wrap_text_search">
            <?= ($prospect != '' && $prospect != 'all')? '<span class="text_search">Prospect: <strong>'.$prospect.'</strong></span>' : '' ?>
            ...
            <?= ($device != 'all')? '<span class="text_search">Device: <strong>'.$device.'</strong></span>' : '' ?>
            <?= ($site != 'all')? '<span class="text_search">Site: <strong>'.$site.'</strong></span>' : '' ?>
            ...
            <?= ($language != 'all')? '<span class="text_search">Language: <strong>'.$language.'</strong></span>' : '' ?>
        </p>
    </div>
...
$js = <<<'TXT'
    ...
    var CHART1, CHART2;
    var DATA_CHART1, DATA_CHART2;
    var OPTION_CHART1, OPTION_CHART2;
    var data_grap = {};
    var data_grap2 = {};
    var years = [];
