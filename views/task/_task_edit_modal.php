        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h6 class="modal-title"><?= Yii::t('app','New/Edit task') ?></h6>
                </div>
                <div class="modal-body">
                    <form id="taskForm" method="post" class="">
                        <?= Html::hiddenInput('id', 0) ?>
                        <p class="text-warning"><i class="fa fa-exclamation"></i> Task status will become "Not completed".</p>
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label class="control-label"><?= Yii::t('app', 'Task description') ?></label>
                                    <?= Html::textInput('description', '', ['class'=>'form-control']) ?>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"><?= Yii::t('app', 'Priority?') ?></label>
                                    <?= Html::dropdownList('is_priority', '', ['no'=>'No', 'yes'=>'Yes'], ['class'=>'form-control']) ?>
                                </div>                                
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"><?= Yii::t('app', 'When') ?></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"><?= Yii::t('app', 'Duration (mins)') ?></label>
                                    <?= Html::textInput('mins', '60', ['class'=>'form-control']) ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?= Yii::t('app', 'Assign task to') ?></label>
                        ...
                        <div class="form-group">
                            ...
                            <?= Yii::t('app', 'or') ?> <a href="javascript:;" data-dismiss="modal"><?= Yii::t('app', 'Cancel') ?></a>
                        </div>
                    </form>
                </div>
            </div>
