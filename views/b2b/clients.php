		...
		<div class="table-responsive">
			<table class="table table-responsive table-striped table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?= Html::a($account['name'], '@web/b2b/client/'.$account['id']) ?></td>
						...
						<td><!--
							...
							- -->
							<?= Html::a('Cases', '@web/b2b/client/'.$account['id']) ?>
							-
							<?= Html::a('Tours', '@web/b2b/client/'.$account['id'].'?view=tour') ?>
							-
							<?= Html::a('Edit login', '@web/b2b/client-login/'.$account['id']) ?>
						</td>
					</tr>
					<? } ?>
				</tbody>
