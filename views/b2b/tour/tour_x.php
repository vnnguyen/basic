...
<div class="col-md-8" id="col1">
    <ul class="note-list">
        <li class="first xnote-list-item clearfix">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title">Post your messages here</h6>
                </div>
            ...
            <?= $this->render('tour_x__editor.php', ['theTour'=>$theTour]) ?>
            </div>
                </div>
            </div>
        </li>
...
<div class="col-md-4" id="col2">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title"><span class="text-bold text-uppercase"><?= Yii::t('op', 'Itinerary') ?></span> <?= $theTour['day_count'] ?> <?= Yii::t('op', 'days') ?>, <?= Yii::t('op', 'from') ?> <?= date('j/n/Y', strtotime($theTour['day_from'])) ?> <?= Html::a(Yii::t('op', 'Itinerary'), '@web/products/r/'.$theTour['id']) ?> - <?= Html::a(Yii::t('op', 'Notes'), '@web/tours/ctn/'.$theTour['id']) ?>
            <a href="#" onclick="$('#col1, #col3').toggle(); $('#col2').toggleClass('col-md-4 col-md-8'); return false;">Toggle</a>
            </h6>
        </div>
        <div class="table-responsive">
            <table class="table table-condensed">
                <thead>
                    <tr>
                        <th>TT</th>
                        <th class="no-padding-left">Activities</th>
                    </tr>
                </thead>
                <tbody>
<?
...
<div class="col-md-4" style="display:none" id="col3">
    <div class="row">
            ...
            <? if (empty($theTour['tour']['tasks'])) { ?><p><?= Yii::t('op', 'No tasks found') ?>. <?= Html::a('Add tasks', '@web/tasks/c?rtype=tour&rid='.$theTour['tour']['id']) ?></p><? } else { ?>
