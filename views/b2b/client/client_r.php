...
<div class="col-md-8">
	<? if ($view == 'cases') { ?>
	<p><strong>CLIENT CASES | <?= Html::a('TOURS', '@web/b2b/clients/r/'.$theAccount['id'].'?view=tours') ?></strong></p>
	...
	<? } else { ?>
	<p><strong><?= Html::a('CASES', '@web/b2b/clients/r/'.$theAccount['id']) ?> | CLIENT TOURS</strong>
	<div class="table-responsive">
		<table class="table table-responsive table-bordered">
			<thead>
				<tr>
