...
if ($theProgram->isNewRecord) {
    ...
    Yii::$app->params['page_breadcrumbs'][] = ['B2B', 'b2b'];
...
<div class="col-md-8">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Program detail</h6>
        </div>
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-3"><?= $form->field($theProgram, 'language')->dropdownList($languageList, ['prompt'=>'- Select -'])->label('Language') ?></div>
