...
$this->title = 'Tour khởi hành theo tháng ('.count($theBookings).')';
...
<div class="col-md-12">
	<form class="well well-sm form-inline mb15">
		...
		<input name="khoihanh" value="<?= isset($getKhoihanh)? $getKhoihanh: ''?>" type='text' class="form-control datepicker-here" id="selme" data-min-view="<?= ($getTypeDate == 'm')? 'months': 'years'?>" data-view="<?= ($getTypeDate == 'm')? 'months': 'years'?>" data-view="<?= ($getTypeDate == 'm')? 'months': 'years'?>"
		...
		<?= Html::dropdownList('stype_tour', $getStypeTour, ['b2b'=>'Request', 'b2b-series'=>'Series'], ['class'=>'form-control', 'prompt'=>'Tour stype']) ?>
