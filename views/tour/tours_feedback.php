...
?>
    ...
    <style>
        ...
        .table-borderless tbody+tbody, .table-borderless td, .table-borderless th, .table-borderless thead th {padding-bottom: :6px; border-bottom: 1px solid #e6e3d9!important;}
        ...
        .nav-item {min-width:111px; max-width:112px; overflow:hidden;}
    ...
    /*        .nav-tabs .nav-item.show .nav-link, .nav-tabs .nav-link.active {border:1px solid #fff; border-bottom:2px solid #e35429;}
            .nav-tabs .nav-item.show:hover .nav-link, .nav-tabs:hover .nav-link.active {border:1px solid #e6e3d9; border-bottom:2px solid #e6e3d9;}*/
    </style>
</head>
<body>
...
if (strpos($op, '::') !== false) {
                ...
                <div class="wrap_form">
                    ...
                    <div class="comment">
                        ...
                        <div class="form-group op_fix">
                            ...
                            <!-- upload -->
                            <input id="input-pr-rev" name="inputUpload[]" type="file" multiple class="file">
                            <!-- end upload -->
                        </div>
    ...
    <div class="modal fade" id="thankModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-fix" role="document">
        <div class="modal-content">
          <div class="modal-header head_fix" style="background-image: url(/img/DSCF0285.JPG); background-size: cover;">
    ...
    <div class="footer contain amica-travel-notification">
        <img alt="" class="img-fluid img-lazy fix-img-bottom-left" src="/img/bg-left.png" data-pagespeed-url-hash="3000603361" data-pagespeed-onload="pagespeed.CriticalImages.checkImageForCriticality(this);" onload="var elem=this;if (this==window) elem=document.body;elem.setAttribute('data-pagespeed-loaded', 1)" data-pagespeed-loaded="1">
    </div>
