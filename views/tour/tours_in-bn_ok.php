...
<body>
	...
	<table style="width:100%; border-bottom:5px solid #ddd; margin-bottom:32px;">
		<tr>
			<td style="text-align:left; height:200px; max-height:200px;">
				<? if ($theForm['logo'] == 'amica') { ?>
				<img style="max-height:200px;" src="<?= Yii::$app->params['print_logo'] ?>">
				<? } elseif ($theForm['logo'] == 'si') { ?>
				<img style="max-height:200px;" src="/assets/img/logo_si_160922_1248x664.jpg">
				<? } else { ?>
				<img style="max-height:200px;" src="<?= $theTour['bookings'][0]['case']['company']['image'] ?>">
				<? } ?>
			</td>
			<td style="text-align:right">
				...
				Secret Indochina
				<? } else { ?>
				<?= $theTour['bookings'][0]['case']['company']['name'] ?>
				<? } ?>
				</div>
				<? if ($theForm['extra'] != '') { ?>
