...
if (isset($_GET['xh'])) {
    foreach ($theTours as $tour) {
        // echo '<br>', $tour['op_code'], ' - ', $tour['op_name'];
                ...
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3"><?= Yii::t('x', 'Status OP') ?></label>
                                <div class="col-sm-9"><?= Html::dropdownList('op_status', $op_status, ['op'=>'Operation', 'prebooked'=>'Prebooked'], ['class'=>'form-control', 'prompt'=>Yii::t('x', 'Operation status')]) ?></div>
                            </div>
                            <div class="form-group row">
