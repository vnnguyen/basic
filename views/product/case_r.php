...
<div class="col col-1">
    ...
    <table class="table table-bordered table-xxs table-striped mb-20">
        <tbody>
            <tr>
                <td>
    ...
    <div class="mb-1em">
        ...
        <?= Html::a(Yii::t('k', '+Program'), '@web/products?ub='.Yii::$app->user->id, ['class'=>'text-muted']) ?>
        </div>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tr>
                <td>
                    ...
                    <?= Html::a('<i class="fa fa-pdf-o"></i>', '/products/download/'.$booking['product']['id'], ['title'=>'Download PDF', 'style'=>'color:#FC6249']) ?>
                    <? } ?>
    ...
    <div class="mb-1em">
        ...
        <div style="border-left:4px solid #d6c6b6; padding-left:8px; margin-left:8px;;">
            ...
            <div style="padding:2px;">
                ...
                <i id="icon-<?=$t['id']?>" data-task_id="<?=$t['id']?>" class="cursor-pointer task-check fa fa-<?= $t['status'] == 'on' ? '' : 'check-' ?>square-o"></i>
                <?
                if ($t['fuzzy'] == 'date') {
                    // Echo nuffin'
                } else {
        ...
        <li class="note-list-item clearfix">
            ...
            <div class="note-content">
                ...
                <div class="mb-1em">
                    ...
                    <? if (in_array(Yii::$app->user->id, [1, 1087, 26435, $theCase['owner_id']])) { ?>
