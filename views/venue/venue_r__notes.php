...
<div class="col-lg-6 col-md-7">
    <ul class="media-list">
        ...
        <div style="padding:15px 0; margin:15px 0 0; border-top:1px solid #eee;">
            <a class="pull-left" style="margin-right:15px;" href="<?= DIR ?>users/r/<?= $li['updatedBy']['id'] ?>"><img style="width:64px; height:64px;" class="media-object rounded-circle" src="<?= DIR.'timthumb.php?w=100&h=100&src='.$li['updatedBy']['image'] ?>" alt="Avatar"></a>
            ...
            <div><?= $li['updatedBy']['name'] ?> <em><?= $li['created_dt'] ?></em></div>
            <div style="margin-left:80px" class="clear clearfix">
            <? if (!empty($li['attachments'])) { ?>
            <div class="list list-files mb-1em">
                <? foreach ($li['attachments'] as $file) { ?>
