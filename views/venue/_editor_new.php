...
<div id="div-post-here" class="d-none">
    <div class="message-body">
        ...
        <div class="form-group" style="border:1px solid #ccc;">
            ...
            <div id="mydzfiles" style="padding:8px; text-align:center; cursor:pointer; background-color:#e5f0ff"><?= Yii::t('x', 'Click or drag and drop files here to attach') ?></div>
        </div>
        <div class="form-group">
