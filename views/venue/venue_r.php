    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="heading-elements panel-nav">
                <ul class="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li><a href="#t-prices_new" data-toggle="tab">New Prices</a></li>
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <?php include('venue_r__faci.php'); ?>
                <?php include('venue_r__notes.php'); ?>
                <?php include('venue_r__prices.php'); ?>
                <?php include('venue_r__promo.php'); ?>
                <?php include('venue_r__media.php'); ?>
                <?php include('venue_r__fb.php'); ?>
                <?php include('venue_r__tours.php');?>
                <?php include('venue_r_price_new.php');?>
...
$('#t-prices_new').on('click', 'a.dv_d', function(event){
    event.preventDefault();
    var id = $(this).data('id');
    var jqxhr = $.post('/dv/d/' + id, {x:'x'})
    .done(function(data) {
