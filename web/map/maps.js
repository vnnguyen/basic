    ...
    if( document.getElementById(element) != null ){
        ...
        function placeMarkers(markers){
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                if( markers[i]["marker_image"] != undefined && markers[i]["marker_image"] != ''){
                    thumbnailImage = markers[i]["marker_image"];
                }
                else {
                    thumbnailImage = "/map_img/items/default.png";
                }
...
function simpleMap(_latitude,_longitude, element, markerDrag, place){
    ...
    function drawMap(mapCenter){
        ...
        var marker = new RichMarker({
            ...
            content: "<img src='/map_img/marker.png'>",
            flat: true
        });
