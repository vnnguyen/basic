...
class ExportConcatFiles extends \yii\base\Action
{
    public function run(
        $name = '',
        $gender = '',
        ...
        if (Yii::$app->request->get('output') == 'download') {
            ...
            if ($limit > 0) {
                ...
                for ( $page = 0 ; $page < $pages ; $page++ ) {
                    ...
                    !file_exists($direct) && mkdir($direct , 0777);
                    $FileNames[] = $direct . '/page' . $page . '.xlsx';
                    $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheet, "Xlsx");
                    $writer->save($direct . '/page' . $page . '.xlsx');
                }
            }
            ...
            rmdir($direct);
            // $writer = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($spreadsheetMain, 'Xlsx');
